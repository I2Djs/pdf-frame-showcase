    ...
    >
      ...
      <i-page p-template="temp-1">
        ...
        <i-text 
          ...
          :y="50"
          text="PDF-frame"
          link="https://github.com/I2Djs/I2Djs"
          :style="{ fill: '#ffffff',textAlign:'center', font: '12px', underline: true }"
        />
        <i-text 
          :x="0"
          :y="80"
          text="Goto - Page 2 >>"
          goto="page2"
          :style="{ fill: '#ffffff',textAlign:'center', font: '12px' }"
        />
        <i-text 
          :x="30"
          :y="150"
          ...
          :style="{ fill: '#ffffff',textAlign:'justify', font: '12px', underline: true }"
        />
        ...
        <i-text 
          ...
          :width="540"
          text="PDF-frame is a web framework for client side PDF generation. With its declarative HTML syntax and semantics, it offers a easy way to define PDF graphical content efficiently. It provides component support for popular frameworks like Vue, nuxt and React(work in progress). Built on the i2djs framework, PDF-frame presently supports rendering outputs in PDF and Canvas formats."
          :style="{ fill: '#ffffff',textAlign:'justify', font: '12px', strike: true }"
        />
        ...
        <i-text 
          ...
          :width="540"
          text="PDF-frame is a web framework for client side PDF generation. With its declarative HTML syntax and semantics, it offers a easy way to define PDF graphical content efficiently. It provides component support for popular frameworks like Vue, nuxt and React(work in progress). Built on the i2djs framework, PDF-frame presently supports rendering outputs in PDF and Canvas formats."
          :style="{ fill: '#ffffff',textAlign:'justify', font: '12px', oblique: true }"
        />
      </i-page>
      <i-page p-template="temp-1">
        <i-text 
          ...
          text="Page - 2"
          anchor="page2"
          :style="{ fill: '#ffffff',textAlign:'center', font: '70px' }"
        />
      </i-page>
    </pdfFrame>
</template>
